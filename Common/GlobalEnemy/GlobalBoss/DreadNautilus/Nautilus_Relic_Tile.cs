...
{
    public class Nautilus_Relic_Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "VanillaAdditions/Common/GlobalEnemy/GlobalBoss/DreadNautilus/Nautilus_Relic_Tile";
        public override string Texture => "VanillaAdditions/Common/GlobalEnemy/GlobalBoss/DreadNautilus/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<Nautilus_Relic>();
                    break;
            }
